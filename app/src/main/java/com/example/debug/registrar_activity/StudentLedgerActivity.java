...
import com.example.debug.registrar_fragments.StatementOfAccountsFragment;
import com.example.debug.registrar_fragments.SummaryOfAccountsFragment;
...
public class StudentLedgerActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent intent = new Intent(StudentLedgerActivity.this, RegistrarActivity.class);
