...
import com.example.debug.registrar_fragments.EnrolledSubjectFragment;
import com.example.debug.registrar_fragments.EnrollmentListFragment;
...
public class Registrar2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.registrar2_activity), (v, insets) -> {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent intent = new Intent(Registrar2Activity.this, RegistrarActivity.class);
