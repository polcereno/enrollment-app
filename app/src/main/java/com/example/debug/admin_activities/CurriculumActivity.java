...
public class CurriculumActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.curriculumToolbar);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.curriculum_activity), (v, insets) -> {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent intent = new Intent(CurriculumActivity.this, RegistrarActivity.class);
