...
public class DueAmountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.dueAmountToolbar);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.due_amount_activity), (v, insets) -> {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent intent = new Intent(DueAmountActivity.this, StudentActivity.class);
