...
public class GradingSheetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.gradingSheetToolbar);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.grading_sheet_activity), (v, insets) -> {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent intent = new Intent(GradingSheetActivity.this, RegistrarActivity.class);
